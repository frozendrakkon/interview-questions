...
93. **Расскажите о методах Promise**
...
95. **Что происходит с массивами, когда мы пытаемся их сложить?**
