...
5. **В чем отличия Function expression и Function declaration**
   ...
   1. _У стрелочных функций нет arguments и this_
...
72. **Зачем нужны функции call и apply?**

76. **Как работает прототипное наследование**
...
77. **В чем отличие forEach от map?**
...
78. **В чем разница между переменной , которая является: null, undefined?**
...
79. **Что вы можете рассказать о необъявленной переменной?**
...
81. **В чем разница между объектами хоста и собственными объектами?**
...
83. **Что такое тернарный оператор, почему он так называется**
...
85. **Объясните разницу между синхронными и асинхронными функциями.**
...
90. **Как называются внутренние свойства Promise?**

    - state («состояние») — вначале "pending" («ожидание»), потом меняется на "fulfilled" («выполнено успешно») при вызове resolve или на "rejected" («выполнено с ошибкой») при вызове reject.
    - result («результат») — вначале undefined, далее изменяется на value при вызове resolve(value) или на error при вызове reject(error)

91. **Расскажите о методах Promise**
...
92. **Что вы можете рассказать про асинхронность?**
...
94. **Что происходит с массивами, когда мы пытаемся их сложить?**
...
97. **Почему js не может работать напрямую с памятью компьютера?**
...
100. **Что происходит, когда мы вводим url в адресную строку и нажимаем enter?**
     - Браузер ищет сервер по IP адресу, устанавливает соединение, отправляет Http запрос на получение контента, после получения рендерит страницу
101. **Что приходит с сервера первым html/css/js или все вместе?**
...
104. **В чем отличия неопределенной переменной и необъявленной?**
...
105. **Почему мы можем обратиться к свойству примитивного типа, ведь это примитив?**
...
106. **Как проверить число на NaN?**
     - Существует несколько способов проверить число на тип NaN
     > Object.is()
     > isNaN()
     > Полифилл
...
107. **Как работает eventLoop?**
     - В js существуют макрозадачи и микрозадачи. 
     - микрозадачи - это задачи, который выполняются "очередью", например console.log, alert...
     - макрозадачи - это задачи, которые "ждут своего часа" - различные events, setTimeout, асинхронные операции ...
108. ****
109. ****
110. ****
111. ****
